...
def listen(remote: str, broadcast: str) -> None:
    global EXTERNAL_GAME_HOST_IP, LOCAL_BROADCAST_ADDRESS
    EXTERNAL_GAME_HOST_IP = remote
    LOCAL_BROADCAST_ADDRESS = broadcast
...
if __name__ == "__main__":
    print("Script cannot be run directly. Please run scct.py client instead.")
